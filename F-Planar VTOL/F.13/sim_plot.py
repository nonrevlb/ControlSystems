...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.num_of_rows = 7    # Number of subplot rows
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0][0],1,'t(s)', 'h(m)', 'h'))
        self.handle.append(myPlot(self.ax[0][1],1,'t(s)', 'h error(m)', 'h error'))
        self.handle.append(myPlot(self.ax[1][0],1,'t(s)', 'hdot', 'hdot'))
        self.handle.append(myPlot(self.ax[1][1],1,'t(s)', 'hdot error', 'hdot error'))
        self.handle.append(myPlot(self.ax[2][0],1,'t(s)', 'z(m)', 'z'))
        self.handle.append(myPlot(self.ax[2][1],1,'t(s)', 'z error(m)', 'z error'))
        self.handle.append(myPlot(self.ax[3][0],1,'t(s)', 'zdot', 'zdot'))
        self.handle.append(myPlot(self.ax[3][1],1,'t(s)', 'zdot error', 'zdot error'))
        self.handle.append(myPlot(self.ax[4][0],1,'t(s)', 'theta', 'theta'))
        self.handle.append(myPlot(self.ax[4][1],1,'t(s)', 'theta error', 'theta error'))
        self.handle.append(myPlot(self.ax[5][0],1,'t(s)', 'thetadot', 'thetadot'))
        self.handle.append(myPlot(self.ax[5][1],1,'t(s)', 'thetadot error', 'thetadot error'))
        self.handle.append(myPlot(self.ax[6][0],1,'t(s)','N','force'))
        self.handle.append(myPlot(self.ax[6][1],1,'','','Extra'))
        ####################################################################
