...
class Sliders:
    ...
    def __init__(self):
        ...
        self.Sfr = mySlider(self.num_of_sliders,1,
            P.Fr0+1,P.Fr0-1,P.Fr0,1,'Force(right)')
        self.Sfl = mySlider(self.num_of_sliders,2,
            P.Fl0+1,P.Fl0-1,P.Fl0,1,'Force(left)')
    ...
    def getInputValues(self):
        ...
        # SECTION 3
        ################################################################
        values = [self.Sfr.getValue(),self.Sfl.getValue()]
        ################################################################
        return values
