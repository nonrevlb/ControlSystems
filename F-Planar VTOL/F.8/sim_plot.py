...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.num_of_rows = 4    # Number of subplot rows
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0],1,'t(s)', 'h(m)', 'h'))
        self.handle.append(myPlot(self.ax[1],1,'t(s)', 'z(m)', 'z'))
        self.handle.append(myPlot(self.ax[2],1,'t(s)', 'theta', 'theta'))
        self.handle.append(myPlot(self.ax[3],1,'t(s)','N','force'))
        ####################################################################
