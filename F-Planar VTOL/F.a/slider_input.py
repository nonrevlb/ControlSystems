...
class Sliders:
    ...
    def __init__(self):
        ...
        # SECTION 1
        ###############################################################
        self.num_of_sliders = 4 # The number of Slider objects that
        ...
        self.Szv = mySlider(self.num_of_sliders,1,
            10*P.d,0,5.0*P.d,1,'z copter')
        self.Sh = mySlider(self.num_of_sliders,2,
            10*P.d,0,5.0*P.d,1,'h copter')
        self.Stheta = mySlider(num_of_sliders = self.num_of_sliders,
            slider_number = 3, maxV = 360,minV = 0,intV =0,
            gain = np.pi/180, name ='theta')
        self.Szt = mySlider(self.num_of_sliders,4,
            10*P.d,0,5.0*P.d,1,'z target')
    ...
    def getInputValues(self):
        ...
        # SECTION 3
        ################################################################
        values = [self.Szv.getValue(),self.Sh.getValue(),self.Stheta.getValue(),self.Szt.getValue()]
        ################################################################
        return values
