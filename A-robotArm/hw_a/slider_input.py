...
class Sliders:
    ...
    def __init__(self):
        ...
        # SECTION 1
        ###############################################################
        self.num_of_sliders = 1
                                # The number of Slider objects that
        ...
        self.Stheta = mySlider(self.num_of_sliders,1,
            180,-180,P.theta0,np.pi/180,'theta') 
