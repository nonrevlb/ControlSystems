...
from animation import robotArmAnimation
...
ctrl = controllerPID()              # Instantiate controllerPD class
simAnimation = robotArmAnimation()  # Instantiate Animate class
dynam = robotArmDynamics()          # Instantiate Dynamics class
...
while t < t_end:
	...
	simAnimation.drawRobotArm(          # Update animation with current user input
		dynam.Outputs())
	plt.pause(0.0001)
