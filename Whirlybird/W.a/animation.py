...
class Animation:
	...
	def drawWhirlybird(self,phi,theta,psi):
		...
		if self.flagInit == True:
			...
			self.PolyCollections.append(Poly3DCollection([np.asarray(verts[2])],facecolor = 'red',edgecolor = 'black', lw = 2))
			self.PolyCollections.append(Poly3DCollection([np.asarray(verts[3])],facecolor = 'green',edgecolor = 'black', lw = 2))
