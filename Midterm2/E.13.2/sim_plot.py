...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[0][1],1,'t(s)','theta','Angle'))
        self.handle.append(myPlot(self.ax[1][0],1,'t(s)','estimation error','Errors'))
        self.handle.append(myPlot(self.ax[1][1],1,'t(s)','N','force'))
        ####################################################################
