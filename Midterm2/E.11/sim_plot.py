...
class plotGenerator:
    ...
    def __init__(self):
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0],1,'t(s)', 'x(m)','Position'))
        self.handle.append(myPlot(self.ax[1],1,'t(s)','theta','Angle'))
        self.handle.append(myPlot(self.ax[2],1,'t(s)','F(N)','Force'))
        ####################################################################
