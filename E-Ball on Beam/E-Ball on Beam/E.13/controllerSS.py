...
class controllerSS:
  ...
  def __init__(self):
      ...
      self.SSCtrl = SS_ctrl(P.K,P.ki,P.L,P.z0,P.theta0,P.F_max)
...
class SS_ctrl:
  def __init__(self,K,ki,L,z0,theta0,limit):
      ...
      self.input_disturbance = P.input_disturbance
  ...
  def SS_loop(self,z_r,z,theta):
      ...
      F_unsat = P.F0 -self.K*(self.xhat-P.x0) - self.ki*self.integrator
