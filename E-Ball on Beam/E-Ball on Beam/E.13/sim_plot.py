...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.num_of_cols = 3    # Number of subplot columns
        ##############################################################
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0][0],1,'t(s)', 'z(m)','z'))
        self.handle.append(myPlot(self.ax[0][1],1,'t(s)', 'z error(m)','z error'))
        self.handle.append(myPlot(self.ax[0][2],1,'t(s)','zdot','zdot'))
        self.handle.append(myPlot(self.ax[1][0],1,'t(s)','zdot error','zdot error'))
        self.handle.append(myPlot(self.ax[1][1],1,'t(s)','theta','Angle'))
        self.handle.append(myPlot(self.ax[1][2],1,'t(s)','theta error','Angle error'))
        self.handle.append(myPlot(self.ax[2][0],1,'t(s)','thetadot','thetadot'))
        self.handle.append(myPlot(self.ax[2][1],1,'t(s)','thetadot error','thetadot error'))
        self.handle.append(myPlot(self.ax[2][2],1,'t(s)','N','force'))
        ####################################################################
