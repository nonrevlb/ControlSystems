...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.num_of_rows = 5    # Number of subplot rows
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0],1,'t(s)', 'z(m)', 
                                 'z/zhat'))
        self.handle.append(myPlot(self.ax[1],1,'t(s)','','zdot/zhatdot'))
        self.handle.append(myPlot(self.ax[2],180.0/np.pi,'t(s)','deg','theta'))
        self.handle.append(myPlot(self.ax[3],1,'t(s)','','thdot/thhatdot'))
        self.handle.append(myPlot(self.ax[4],1,'t(s)','N','force'))
        ####################################################################
