...
class plotGenerator:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[0][1],1,'t(s)', 'z error','z error'))
        self.handle.append(myPlot(self.ax[1][0],1,'t(s)','v','velocity'))
        self.handle.append(myPlot(self.ax[1][1],1,'t(s)','v error','velocity error'))
        self.handle.append(myPlot(self.ax[2][0],1,'t(s)','N','force'))
        self.handle.append(myPlot(self.ax[2][1],1,'-','-','Extra'))
        ####################################################################
